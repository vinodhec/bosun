...
function briefPrompt(lead) {
  ...
  const lines = [
    ...
    '- opener: one natural first line the agent can say, referencing what they browsed. The caller is',
    '  from MaadiVeedu (maadiveedu.com) — write "this is MaadiVeedu calling", NEVER a placeholder like',
    '  [Agent Name] or [Company Name]; the agent adds their own name.',
    '',
    '── LEAD CONTEXT ──',
    L.name ? `Name: ${L.name}` : '',
